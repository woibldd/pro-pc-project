<template>
  <div class="card-order-wrap lineBG2">
    <div class="order-top" flex="main:justify cross:center" @click="handleClickBody">
      <div class="order-top-left" flex="main:left cross:center"> 
        ...
        <div class="nft-series">
          ...
          <div class="series-chain">
            <span class="text3">{{info.chain}}</span>
    ...
    <div class="order-main">
      <div class="order-row" flex="main:left" @click="handleClickBody">
